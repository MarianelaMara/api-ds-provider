...
ActiveRecord::Schema[7.0].define(version: 2023_10_17_195831) do
  ...
  create_table "calendars", force: :cascade do |t|
    ...
    t.integer "year"
    t.date "free_dates", default: [], array: true
    t.date "booked_dates", default: [], array: true
    t.index ["maker_id"], name: "index_calendars_on_maker_id"
  end
  ...
  add_foreign_key "calendars", "makers"
